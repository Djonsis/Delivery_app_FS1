...
import { ListOrdered, LayoutDashboard, Settings, FileText, Package, Database, Folder, Layers } from "lucide-react";
          ...
          <SidebarContent>
            <SidebarMenu>
              <SidebarMenuItem>
               ...
               <SidebarMenuItem>
                <Link href="/admin/weight-templates">
                  <SidebarMenuButton tooltip="Шаблоны">
                    <Layers />
                    Шаблоны
                  </SidebarMenuButton>
                </Link>
