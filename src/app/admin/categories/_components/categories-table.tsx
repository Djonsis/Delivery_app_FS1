      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead>Префикс SKU</TableHead>
        ...
        <TableBody>
          {categories.map((category) => (
            <TableRow key={category.id}>
              ...
              <TableCell>{category.sku_prefix}</TableCell>
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        Это действие нельзя отменить. Категорию можно будет
                        удалить, только если она не используется ни одним товаром.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
