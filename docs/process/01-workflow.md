...
**Критически важно:** Мы не можем передавать контекст между чатами напрямую. Наша документация (`/docs`) — это наша **общая память**. Решения, принятые в стратегическом чате, должны быть зафиксированы в ней перед началом работы в тактическом чате.
